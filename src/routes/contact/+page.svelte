  ...
  <div class="container flex flex-wrap px-5 py-24 mx-auto sm:flex-nowrap">
    ...
    >
      <iframe
        ...
        marginwidth="0"
        scrolling="no"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2434.1392281023714!2d16.947079376785776!3d52.40415284480009!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47045b85e236103b%3A0x8030a1c59859cfa9!2sCentrum%20Wyk%C5%82adowe%20PP!5e0!3m2!1spl!2spl!4v1713451167782!5m2!1spl!2spl"
      ...
      <div class="relative flex flex-wrap py-6 bg-white rounded shadow-md">
        <div class="px-6 lg:w-1/2">
          ...
          <p class="mt-1">
            Polska,&nbsp;61-965&nbsp;Poznań,<br />ul.&nbsp;Piotrowo&nbsp;2
          </p>
        </div>
        <div class="px-6 mt-4 lg:w-1/2 lg:mt-0">
          ...
          <a
            href="mailto:contact@rentme.pl"
            class="leading-relaxed text-primary-500">contact@rentme.pl</a
          >
          <h2
          ...
          <p class="leading-relaxed">+48 123-456-780</p>
        </div>
      </div>
    </div>
    <div
